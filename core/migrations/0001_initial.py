# Generated by Django 4.1.6 on 2023-03-12 18:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.author', verbose_name='Авторы')),
            ],
            options={
                'verbose_name': 'Книга',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edited', models.DateTimeField(auto_now=True, verbose_name='Дата последнего редактирования')),
                ('book_list', models.ManyToManyField(blank=True, related_name='books', to='core.book', verbose_name='Список книг')),
